...
/* Loads a segment starting at offset OFS in FILE at address
   UPAGE.  In total,  _BYTES + ZERO_BYTES bytes of virtual
...
static bool setup_stack (void **esp)
{
  /* Shreya A., Shreya V., Jyotsna, and Garv driving */

  /**
   * What our stack should look like:
   * PHYS_BASE
   * argument 0
   * argument 1
   * alignment bytes
