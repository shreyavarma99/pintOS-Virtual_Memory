...
static struct thread *initial_thread UNUSED;
...
struct thread
{
  ...
  struct file *files[128]; /* Files that the thread has open right now */
  int current_fd; /* Track the most recent file descriptor */

  /* userprog variables */
  struct thread *parent; /* pointer to parent */
  struct list children; /* list of children */
  struct list_elem child_elem; /* list element */
  int child_exit_status; /* chi exit status */
